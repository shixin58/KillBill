...
public class Cube extends Shape {
    ...
    public Cube(View view) {
        ...
        ByteBuffer bb = ByteBuffer.allocateDirect(
                mCubePositions.length * 4);
        bb.order(ByteOrder.nativeOrder());
        vertexBuffer = bb.asFloatBuffer();
        vertexBuffer.put(mCubePositions);
...
//        GLES20.glUniform4fv(mColorHandle, 2, color, 0);
        ...
        GLES20.glVertexAttribPointer(mColorHandle,4,
                ...
                0,colorBuffer);
        //索引法绘制正方体
        GLES20.glDrawElements(GLES20.GL_TRIANGLES, mIndexes.length, GLES20.GL_UNSIGNED_SHORT, indexBuffer);
        //禁止顶点数组的句柄
